public class Principal {
    public static void main(String[] args) {
        ...
        BuscaSequencial buscador = new BuscaSequencial();
        int indiceEncontrado = buscador.buscar(listaNumeros, 600);
        
        if (indiceEncontrado != -1) {
            System.out.println("O índice do número 600 é: " + indiceEncontrado);
        } else {
